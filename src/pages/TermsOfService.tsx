    ...
    >
      <div className="max-w-2xl mx-auto">
        ...
        >
          ...
          <Section title="2. Not a Medical Provider">
            <p>
          ...
          <Section title="3. User Responsibilities & Liability">
            <p>As an Artist using Glow Push, you agree that:</p>
            <ul className="list-disc list-inside space-y-1.5 pl-1">
              <li>You are a certified/licensed PMU professional operating in compliance with your local laws and health regulations.</li>
              <li>You are solely responsible for obtaining legally binding, informed consent from your clients before any procedure.</li>
              <li><strong>Limitation of Liability:</strong> Glow Push, its founders, and affiliates shall not be held liable for any direct, indirect, or consequential damages, including but not limited to medical complications, allergic reactions, botched procedures, or legal disputes arising between you and your clients. You agree to indemnify and hold Glow Push harmless against any claims made by your clients.</li>
            </ul>
          </Section>
          ...
          <Section title="5. Data Ownership and Privacy">
            <p>
              You retain ownership of the client data and images you upload. However, you grant Glow Push a license to host and process this data to provide the Service. You are entirely responsible for ensuring your data collection complies with local privacy laws (e.g., GDPR, CCPA). For more details, please review our{' '}
              <Link to="/privacy" className="underline font-bold" style={{ color: '#D4AF37' }}>Privacy Policy</Link>.
            </p>
          </Section>

          <Divider />

          <Section title="6. Service Availability and Data Loss">
            <p>
