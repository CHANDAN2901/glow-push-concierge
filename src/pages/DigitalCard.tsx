...
const DigitalCard = ({ embedded, previewName, previewPhone, previewLogo, previewIg, previewFacebook }: DigitalCardProps = {}) => {
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col items-center" dir="rtl">
      ...
      {/* ===== LOGO & NAME ===== */}
      <div className="relative -mt-16 z-10 flex flex-col items-center gap-4 px-6">
        {(logo || !profileError) ? (
          ...
          <div className="w-40 h-40 rounded-full bg-transparent flex items-center justify-center shadow-[0_4px_20px_rgba(0,0,0,0.1)]">
