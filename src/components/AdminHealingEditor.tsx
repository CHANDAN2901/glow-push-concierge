...
const FALLBACK_PHASES: HealingPhaseRow[] = [
  { id: 'fb-e1', treatment_type: 'eyebrows', day_start: 1, day_end: 3, title_he: 'ימים ראשונים — שמירה והרגעה 💧', title_en: 'Protection & Calm 💧', icon: '💧', severity: 'high', steps_he: ['🧻 לספוג הפרשות בעדינות עם גזה נקייה.', '🧴 למרוח שכבה דקה מאוד של משחה.', '❌💧 אסור להרטיב את האזור במים זורמים!'], steps_en: ['🧻 Gently blot secretions with clean gauze.', '🧴 Apply a very thin layer of ointment.', '❌💧 Do NOT wet the area with running water!'], sort_order: 1 },
  { id: 'fb-e2', treatment_type: 'eyebrows', day_start: 4, day_end: 10, title_he: 'שלב הקילופים — זהירות! 🛡️', title_en: 'Peeling Stage — Caution! 🛡️', icon: '🛡️', severity: 'high', steps_he: ['❌ אסור לגרד או לקלף את הגלד.', '🧴 להמשיך למרוח משחה כשהאזור יבש.', '👀 הצבע ייראה דהוי — זה תקין.'], steps_en: ["❌ Don't scratch or peel the scab.", '🧴 Keep applying ointment.', '👀 Color may look faded — normal.'], sort_order: 2 },
  { id: 'fb-e3', treatment_type: 'eyebrows', day_start: 11, day_end: 20, title_he: 'שלב ה-Ghosting 👻', title_en: 'Ghosting Phase 👻', icon: '👻', severity: 'medium', steps_he: ['👻 הצבע נראה כאילו נעלם? הוא יחזור.', '🧼 אפשר לשטוף פנים כרגיל.', '❌☀️ עדיין להימנע משמש.'], steps_en: ["👻 Color disappeared? It'll come back.", '🧼 Wash face normally.', '❌☀️ Avoid sunlight.'], sort_order: 3 },
  { id: 'fb-e4', treatment_type: 'eyebrows', day_start: 21, day_end: 30, title_he: 'החשיפה הסופית ✨', title_en: 'Final Result ✨', icon: '✨', severity: 'low', steps_he: ['✨ הצבע מתייצב.', '📅 קבעי תור לטאץ׳-אפ.', '🎉 תיהני!'], steps_en: ['✨ Color stabilizing.', '📅 Book touch-up.', '🎉 Enjoy!'], sort_order: 4 },
